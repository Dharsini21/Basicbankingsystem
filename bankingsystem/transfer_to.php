...
<head>
    ...
    <title>Money Transfer - The Sparks Foundation - Bank System</title>
...
<?php
 if(isset($_POST['transfer'])) {
    ...
    <?php
		...
		?>
        <script type="text/javascript">
            alert("Transalation Successfully");
        ...
        <form method="POST" onSubmit="return check()" enctype="multipart/form-data">
            <div class="table-responsive-sm">
                <div class="box">
                    ...
                    <div class="box-r">
                        <label class="col-md-4 control-group">Form :</label>
                    ...
                    <input type="submit" name="transfer" value="Money Transfer" class="btn btn-primary"/>
                </div>
            </div>
            <br>
