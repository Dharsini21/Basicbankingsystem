...
<body>
<div style="background-image: url('image/try4.gif');background-size:cover;">
  <center>
    <?php
    ...
    <section id="main">
      ...
      <div class="table-responsive-sm">
        ...
        <div class="btn">
          <a href="transfer_to.php?id=<?php echo $result['id']?>" class="btn btn-primary" name="transfer_to">Transfer To</a>
          <a href="user.php" class="btn btn-danger" name="back">Back</a>
        </div>
      </div>
      <div class="table-responsive-sm">
        <div class="title_h">
          <p>Hi <?php echo $f_name?>. In is Session your Translation History</p>
        </div>
      </div>
    <div class="table-responsive-sm">
      <table class="table_h">
